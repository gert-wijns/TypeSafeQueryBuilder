...
public class TestResultTransformer {
    ...
    public void testResultTransformerSetsNestedFields() {
        ...
        TypeSafeQueryResultTransformer tf = new TypeSafeQueryResultTransformer(Product.class, paths);
    ...
    public void resultTransformerLoadTest() {
        ...
        for(int i=1; i < 80; i++) {
            projections.addProjection(new TypeSafeValueProjection(dummy, "manyProperties.property" + i));
