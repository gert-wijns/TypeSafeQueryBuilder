...
public interface OnGoingOrderBy {
    ...
    /**
     * Converts to a TypesafeValue and delegates to {@link #desc(TypeSafeValue,boolean)}
     */
    ...
    /**
     * Converts to a TypesafeValue and delegates to {@link #asc(TypeSafeValue,boolean)}
     */
